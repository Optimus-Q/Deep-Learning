...
class GRUSentiment(nn.Module):
    ...
    def __init__(self, num_embed, embed_dim, inp_sz, gru_hidsz, nlayer, seq_len, batch, fc_hidsz, out_sz):
        super(GRUSentiment, self).__init__()
        
        self.num_embed = num_embed
        self.embed_dim = embed_dim
        self.inp_sz = inp_sz
        self.gru_hidsz = gru_hidsz
        self.nlayer = nlayer
        ...
        self.gru = nn.GRU(self.inp_sz, self.gru_hidsz, self.nlayer)
    ...
    def forward(self, x):
        ...
        hidden = torch.zeros(self.nlayer, self.batch, self.gru_hidsz)
